...
namespace hiqdev\yii2\wordpress\pages\controllers;
...
class RenderController extends Controller
{
    ...
    {
        preg_match('/^.+' . $this->module->id . '\/(?<pageName>.+)$/', Yii::$app->request->getUrl(), $matches);
    ...
    private function renderPage(AbstractPage $page, array $params = []): string
    {
        ...
        return $this->render('articles/single', ['model' => $page]);
    }
    ...
    public function actionList(string $listName = null): string
    {
        ...
        return $this->render('articles/category', ['dataProvider' => $list->getDataProvider()]);
    }
}
